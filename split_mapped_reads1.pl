...
if ($sample > 0) {
  ...
  my $subsample = "sambamba view -f bam -t 8 --subsampling-seed=3 -s $frac $BAM -o $bam_sample.bam";
  ...
  my $command_mplipeup_R1 = "sambamba mpileup -t 8 -o $mpileupR1 $bam_R1 --samtools -O -s -q $q -Q $Q -f $genome";
  my $command_mplipeup_R2 = "sambamba mpileup -t 8 -o $mpileupR2 $bam_R2 --samtools -O -s -q $q -Q $Q -f $genome";
  ...
  #run mpileup on the separated Bam files.
  my $command_mplipeup_R1 = "samtools mpileup -f $genome $bam_R1 -o $mpileupR1";
  my $command_mplipeup_R2 = "samtools mpileup -f $genome $bam_R2 -o $mpileupR2";
